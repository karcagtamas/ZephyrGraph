        ...
        \begin{itemize}[<+->]\itemsep9pt
            ...
            \item \textbf{Software Testing}
                \begin{itemize}
                    ...
                    \item Increase \textbf{accuracy} and \textbf{reliability} of the applications.
                    \item \textbf{Incomplete tests} can lead to \textbf{undetected defects}.
                \end{itemize}
            \item \textbf{Cause-Effect Graphs in Testing}
                \begin{itemize}
                    \item \textbf{Model business logic} in a structured representation.
                    ...
                    \item Aid in \textbf{understanding} complex dependencies.
                \end{itemize}
        \end{itemize}
    \end{alertblock}
\end{frame}