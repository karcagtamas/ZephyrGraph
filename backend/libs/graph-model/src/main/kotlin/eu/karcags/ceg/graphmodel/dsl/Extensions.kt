...
fun GraphBuilder.cause(displayName: String, initializer: CauseNodeBuilder.() -> Unit): Node.Cause {
    return CauseNodeBuilder(displayName).apply { initializer() }.validateAndBuild().also { addNode(it) }
}

fun RuleBuilder.cause(displayName: String, initializer: CauseNodeBuilder.() -> Unit): Node.Cause {
    return CauseNodeBuilder(displayName).apply { initializer() }.validateAndBuild().also { cause = it }
}
...
fun AndNodeBuilder.cause(displayName: String, initializer: CauseNodeBuilder.() -> Unit): Node.Cause {
    return CauseNodeBuilder(displayName).apply { initializer() }.validateAndBuild().also { addNode(it) }
}
...
fun OrNodeBuilder.cause(displayName: String, initializer: CauseNodeBuilder.() -> Unit): Node.Cause {
    return CauseNodeBuilder(displayName).apply { initializer() }.validateAndBuild().also { addNode(it) }
}
