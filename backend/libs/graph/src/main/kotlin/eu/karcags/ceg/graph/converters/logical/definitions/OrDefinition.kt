...
@Serializable
class OrDefinition(override val left: LogicalDefinition, override val right: LogicalDefinition) : BinaryLogicalDefinition {
    ...
    override fun stringify(resource: AbstractSignResource): String {
        return resource.get(Sign.Or, left.stringify(resource), right.stringify(resource))
    }
}