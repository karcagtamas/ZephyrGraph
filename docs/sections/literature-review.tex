...
\begin{itemize}
	\item \textbf{Random Test Generation}: Creates test cases by selecting inputs randomly. Easy to implement, useful in stress testing but often result in poor test coverage and may miss critical paths.
