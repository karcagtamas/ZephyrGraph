...
\subsection{Literature Review in Chapter \ref{ch:literature-review}}
...
\subsection{Cause-Effect Graphs: Syntax and Semantics in Chapter \ref{ch:syntax-and-semantics}}
...
\subsection{Transformation of CEG into Logical Formulas, Decision Table and DNF in Chapter \ref{ch:logical-transformation}}
...
\subsection{Automated Test Generation: !!!TODO: Review!!!}
...
\subsection{Application Development in Chapter \ref{ch:application-development}}
...
\subsection{Evaluation and Results \ref{ch:eval-results}}
...
\subsection{Conclusion in Chapter \ref{ch:conclusion}}
