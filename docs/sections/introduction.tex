...
\begin{enumerate}
    \item Introduction:
    \item Literature Review \ref{ch:literature-review}:
          \begin{compactitem}
          ...
          \end{compactitem}
    \item Cause-Effect Graphs: Syntax and Semantics \ref{ch:syntax-and-semantics}:
          \begin{compactitem}
          ...
          \end{compactitem}
    \item Transformation of CEG into Logical Formulas, Decision Table and DNF \ref{ch:logical-transformation}:
          \begin{compactitem}
    ...
    \item Automated Test Generation: !!!TODO: Review!!!
          ...
          \end{compactitem}
    \item Application Development \ref{ch:application-development}:
          \begin{compactitem}
    ...
    \item Case Study / Application Evaluation:
          ...
          \end{compactitem}
    \item Conclusion \ref{ch:conclusion}:
          \begin{compactitem}
